...
import com.example.fitplate.navigation.navigateToAiSousChef
import com.example.fitplate.navigation.navigateToBookmarks
import com.example.fitplate.navigation.navigateToForYou
    ...
    fun navigateToTopLevelDestination(topLevelDestination: TopLevelDestination) {
        trace("Navigation: ${topLevelDestination.name}") {
            ...
            when (topLevelDestination) {
                ...
                TopLevelDestination.AI_SOUS_CHEF -> navController.navigateToAiSousChef(topLevelNavOptions)
            }
        }
    }
